...
const RegisteredPosts = React.lazy(() => import('./views/Admin/Posts/RegisteredPosts'));
...
const routes = [
  ...
  { path: '/posts/edit/:id', name: '観光地情報', component: EditPosts },
  { path: '/posts/', name: '観光地管理', component: Posts },
  { path: '/registeredposts/', name: '新しい観光地管理', component: RegisteredPosts },
  ...
  { path: '/lists/:place_id/place/:id', name: 'Quản lý bài viết', component: Lists },
